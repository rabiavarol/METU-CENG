...
public:
	...
	std::vector<Player*> playersInTheCoordinates(std::vector<Player*> _players, std::vector<Coordinate> attackCoord);
	bool isHorizontal(Coordinate _player, Coordinate _other);
};
